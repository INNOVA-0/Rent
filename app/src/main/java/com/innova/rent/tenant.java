...
public class tenant extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveTenant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if( (TextUtils.isEmpty(name.getText())) || (TextUtils.isEmpty(rentAmount.getText())) || (TextUtils.isEmpty(advanceAmount.getText())))
                { // feilds are required
    ...
    public void fetchData(){
        ...
        int advance_amount= Integer.parseInt(advanceAmount.getText().toString());
...
//            Toast.makeText(tenant.this, "id selected"+ idSelected, Toast.LENGTH_SHORT).show();
        }
